...
export default function TrainingPage() {
  ...
  return <View className='training-page'><View className='training-top'><View><Text className='eyebrow'>进行中的训练</Text><Text className='training-title'>上肢力量日</Text></View><Button onClick={complete}>完成训练</Button></View>
