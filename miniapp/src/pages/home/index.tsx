...
export default function HomePage() {
  ...
  return <View className='home-page'><View className='brand-row'><Text className='brand'>铸力</Text><Text className='date'>{monthWeek}</Text></View>
    ...
    <View className='browse-card'><Text>先浏览功能</Text><Text>可记录力量、有氧、自定义项目、体重趋势和训练消耗。开始训练或进入数据页时，再由你主动选择微信登录。</Text></View>
